...
<div class="position">您所在位置：协会动态 > 详情</div>
      ...
      <div class="detail_con clearfix">
       ...
       <div class="detail_addr">
        <ul>
          ...
          <li class="detail_down"><img src="${pageContext.request.contextPath }/images/society/down.png" />项目表格表格项目表格项目表格项目表格项1<a onclick="upload()">下载</a><a>打开</a></li>
