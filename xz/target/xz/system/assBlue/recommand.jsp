...
<script type="text/javascript">
		...
		window.location.href="listRecommandBlue.action?pageNO="+page.value;
	}
</script>
</head>
...
<div class="nav">
    <div class="navbox">
       <ul id="bannerUlId"> 
            ...
            <li><img src="${pageContext.request.contextPath }/images/society/device.png" align="absmiddle" /></li>
            <li class="nav_block current"><a href="listRecommandBlue.action">会员推荐</a></li>
            <li><img src="${pageContext.request.contextPath }/images/society/device.png" align="absmiddle" /></li>
...
<div class="position">您所在位置：会员推荐</div>

<div class="recommandbox clearfix">
	...
	<fmt:formatDate var="time" value="${t}" pattern="yyyy-MM-dd"/>
      <div class="any_list clearfix">
        <ul>
          <li class="li_bottom">
          <a href="findRecommandById.action?id=${c.id}">${c.title}</a>
          <span>[${time}]</span>
          </li>
        </ul>
      </div>
     ...
     <div class="action">
       ...
       <a href='listRecommandBlue.action?pageNO=1'>首页</a>
       <a href='listRecommandBlue.action?pageNO=${page.pageNO-1 }'>上一页</a>
       <a href='listRecommandBlue.action?pageNO=${page.pageNO}' >${page.pageNO}</a>
       <c:forEach var="i" begin="${page.pageNO+1}" end="${page.pageNO+4}">
       <a href='listRecommandBlue.action?pageNO=${i}' >${i}</a>
       </c:forEach>
       <a href='listRecommandBlue.action?pageNO=${page.pageNO+1}' >...</a>
       <a href='listRecommandBlue.action?pageNO=${page.pageNO+1 }' >下一页</a> 
       <a href='listRecommandBlue.action?pageNO=${page.totalPage }' >尾页</a>
